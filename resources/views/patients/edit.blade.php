        ...
        <form action="{{ route('patients.update', $patients->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="first-name" value="{{ $patients->first_name }}" class="form-control"
                            placeholder="First Name">
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" name="middle-name" value="{{ $patients->middle_name }}" class="form-control"
                            placeholder="Middle Name">
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" name="last-name" value="{{ $patients->last_name }}" class="form-control"
