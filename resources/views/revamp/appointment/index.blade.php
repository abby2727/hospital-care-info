        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header fw-bold">
                    <h4>View Appointment
                        <a href="{{ route('appointmentRevamp.create') }}" class="btn btn-sm btn-primary float-end fw-bold">Add Appointment</a>
                    </h4>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('appointment.revampappointmentqr', $appointment->id) }}" class="btn btn-dark"><i class="fa-solid fa-qrcode"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
