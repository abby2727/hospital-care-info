                ...
                <div class="card">
                    ...
                    <div class="card-body" style="text-align: center;">
                        @php
                            ...
                            $specialist = $appointments->doctor->name;
                            $context = "HELLO $appointments->name $appointments->age years old You have an appointment on date : $date to specialist :  $specialist ";
