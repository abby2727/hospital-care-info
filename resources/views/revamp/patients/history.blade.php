...
@section('content')
    ...
    <script>
        ...
        var imghtml = '<div id="qrfile"><canvas id="out-canvas" width="320" height="240"></canvas>' +
            '<div id="imghelp">SELECT QR CODE PHOTO HERE THEN COPY PASTE TO THE SEARCH BAR BELOW!' +
            '<br>' +
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-body" style="text-align: center;">
                    <button class="btn btn-primary mt-4 fw-bold btn-lg" onclick="setimg()"><span></span>ACTIVATE QR CODE READER </button>
                    <div id="outdiv"></div>
                    <div id="result"></div>
